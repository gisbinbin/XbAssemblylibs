package com.xb.xblibrary.Dateinput;
...
import com.xb.xblibrary.Dateinput.interfaces.WheelViewAdapter;
import com.xb.xblibrary.Dateinput.interfaces.OnWheelChangedListener;
import com.xb.xblibrary.Dateinput.interfaces.OnWheelClickedListener;
...
//		int offset = 60;
		...
		paint.setColor(getResources().getColor(R.color.divisioncolor));
		// 设置线宽
